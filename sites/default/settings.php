...
$config['config_split.config_split.dev']['status']= TRUE; // Pour endre actif les configurations exportés en Dev
$config['config_split.config_split.prod']['status']= TRUE; // Pour endre actif les configurations exportés en Production
/**
 * Settings:
 *
 ...
 * @endcode
 */
$settings['hash_salt'] = 'Oh6DNSfKJBfVoZCijBMMjkBwSVKVr8EdVEz8r4yKUD5z_qPZLxq395t3kAjtBBo6Eccht1SPvQ';
...
$config_directories['sync'] = 'sites/default/files/config_EjFLf6X6tQ3b1CwHXHzYTy5teFd05R6Op7SOj7LAXx6Qi8St-vIWgwrNuIzIEdwgvIFBAB9wjA/sync';
